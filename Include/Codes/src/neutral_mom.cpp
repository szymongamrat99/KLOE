...
{
    Float_t distance = std::sqrt(std::pow(Xcl - neu_vtx[0],2) + std::pow(Ycl - neu_vtx[1],2) + std::pow(Zcl - neu_vtx[2],2));
...
{
    Double_t distance = std::sqrt(std::pow(Xcl - neu_vtx[0],2) + std::pow(Ycl - neu_vtx[1],2) + std::pow(Zcl - neu_vtx[2],2));
