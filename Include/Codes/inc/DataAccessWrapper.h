...
namespace KLOE
{
  ...
  public:
    ...
    const std::vector<Int_t> &GetKinMom() const;
    const std::vector<Int_t> &GetKine() const;
    const std::vector<Int_t> &GetPNum1() const;
    const std::vector<Int_t> &GetPNum2() const;
    const std::vector<Int_t> &GetPNum3() const;
