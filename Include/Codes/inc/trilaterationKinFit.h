...
namespace KLOE
{
    ...
    public:
        ...
        void SetResults(Int_t &bunchnum, std::vector<Float_t> &iptri_kinfit, std::vector<Int_t> &g4takentri_kinfit, std::vector<Float_t> gamma_mom_final[4], std::vector<Float_t> &fourKnetri_kinfit, std::vector<Float_t> &neu_vtx_min, Float_t &Chi2TriKinFit)
        { 
            _bunchnum = bunchnum;
            _iptri_kinfit = iptri_kinfit;
            _g4takentri_kinfit = g4takentri_kinfit;
            for (Int_t i = 0; i < 4; i++) 
                _gamma_mom_final[i] = gamma_mom_final[i];
            _fourKnetri_kinfit = fourKnetri_kinfit;
            _neu_vtx_min = neu_vtx_min;
            _Chi2TriKinFit = Chi2TriKinFit; 
        }
