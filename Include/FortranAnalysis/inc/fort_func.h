...
extern "C"
{
  ...
  void cos_pipi_kaoncm_(float *Bpx, float *Bpy, float *Bpz, float *Broots, float *ip_closest, float *KchLAB, float *Ppich1, float *Ppich2, float *costrk);

  void find_neuclu_(int *nclu, int *ntcl, int *Asscl, int *neuclulist, int *neucluind);
