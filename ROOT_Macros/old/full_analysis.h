...
// Tue Jun 27 19:18:56 2023 by ROOT version 6.24/07
...
class full_analysis : public TSelector {
public :
   ...
   full_analysis(TTree * /*tree*/ =0) { }
   virtual ~full_analysis() { }
   ...
   ClassDef(full_analysis,0);

};

#endif

#ifdef full_analysis_cxx
void full_analysis::Init(TTree *tree)
{
