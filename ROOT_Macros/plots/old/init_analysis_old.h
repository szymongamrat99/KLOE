...
class init_analysis : public TSelector {
public :
   ...
   ClassDef(init_analysis,0);

};

#endif

#ifdef init_analysis_cxx
void init_analysis::Init(TTree *tree)
{
