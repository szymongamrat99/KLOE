...
#ifndef signal_vs_bcg_v3_h
#define signal_vs_bcg_v3_h
...
class signal_vs_bcg_v3 : public TSelector
{
public:
  ...
  signal_vs_bcg_v3(TTree * /*tree*/ = 0) {}
  virtual ~signal_vs_bcg_v3() {}
  ...
  ClassDef(signal_vs_bcg_v3, 0);
};

#endif

#ifdef signal_vs_bcg_v3_cxx
void signal_vs_bcg_v3::Init(TTree *tree)
{
...
Bool_t signal_vs_bcg_v3::Notify()
{
...
#endif // #ifdef signal_vs_bcg_v3_cxx
