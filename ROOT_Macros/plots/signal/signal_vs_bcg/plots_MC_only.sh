...
options=("NO_CUTS" "SHORTER_KAON_PATHS" "OLD_CHI2_CUT" "OLD_TRCSUM_CUT" "OLD_COMBINED_MASS_PI0_CUT" "OLD_MASS_KCH_CUT" "OLD_MASS_KNE_CUT" "OLD_QMISS_CUT" "OLD_OPENING_ANGLE_CUT" "SIMONA_CHI2_CUT" "BAD_CLUS_SIMONA" "SIMONA_KIN_CUTS" "SIMONA_ALL_CUTS" "OMEGA_MASS_T0_CUT" "BLOB" "NO_BLOB")
