...
for (Int_t i = 1; i <= 2; i++)\
{\
    chain->Add(Form("../../../../Subanalysis/InitialAnalysis/root_files/2025-11-23/mk0*all_phys_SIGNAL_MIXED_%d.root",i));\
}\
for (Int_t i = 1; i <= 2; i++)\
{\
    chain->Add(Form("../../../../Subanalysis/InitialAnalysis/root_files/2025-11-23/dk0*SIGNAL_MIXED_%d.root",i));\
}\
