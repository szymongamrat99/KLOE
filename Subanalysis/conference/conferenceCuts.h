...
// Fri Sep  5 00:00:19 2025 by ROOT version 6.24/07
// from TChain INTERF/h1/
//////////////////////////////////////////////////////////

#ifndef conferenceCuts_h
#define conferenceCuts_h
...
class conferenceCuts : public TSelector
{
public:
   ...
   TTreeReaderValue<Int_t> mctruth_int = {fReader, "h_gen_vars.mctruth"};
   ...
   conferenceCuts(TTree * /*tree*/ = 0) {}
   virtual ~conferenceCuts() {}
   ...
   ClassDef(conferenceCuts, 0);
};

#endif

#ifdef conferenceCuts_cxx

Float_t mctruth_int;
TBranch *b_mctruth_int;

void conferenceCuts::Init(TTree *tree)
{
...
#endif // #ifdef conferenceCuts_cxx
