...
// Thu Jul 11 00:21:26 2024 by ROOT version 6.24/07
// from TChain INTERF/h1/
//////////////////////////////////////////////////////////

#ifndef RegenCutAnalysis_h
#define RegenCutAnalysis_h
...
class RegenCutAnalysis : public TSelector {
public :
   ...
   RegenCutAnalysis(TTree * /*tree*/=0) { }
   virtual ~RegenCutAnalysis() { }
   ...
   ClassDef(RegenCutAnalysis,0);

};

#endif

#ifdef RegenCutAnalysis_cxx
void RegenCutAnalysis::Init(TTree *tree)
{
...
Bool_t RegenCutAnalysis::Notify()
{
...
#endif // #ifdef RegenCutAnalysis_cxx
