			...
			else
			{
				...
				else if (hypoCode == KLOE::HypothesisCode::SIGNAL)
				{
					...
					if (cutter.PassCut(0) && cutter.PassCut(1))
					{
						...
						cluster[3].assign(clusterProps.tcl.begin(), clusterProps.tcl.end());
						...
						trilatKinFitObj.GetResults(baseKin.bunchnum, baseKin.ipTriKinFit, baseKin.g4takenTriKinFit, gamma_mom_final, baseKin.KnetriKinFit, baseKin.neuVtxTriKinFit, baseKin.Chi2TriKinFit);
