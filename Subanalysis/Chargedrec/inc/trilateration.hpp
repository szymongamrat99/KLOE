...
int triangle_neurec(Int_t, Int_t, Short_t, Short_t, Short_t, Short_t, Bool_t, Controls::DataType);
int comp_of_methods(int, int, Controls::DataType);
void tri_neurec_kinfit(int, int, int);
void tri_neurec_kinfit_corr(Int_t, Int_t, Short_t, Short_t, Short_t, Short_t, Bool_t, Controls::DataType);
