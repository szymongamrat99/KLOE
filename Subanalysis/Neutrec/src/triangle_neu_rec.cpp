    ...
    for (Int_t i = 0; i < nentries; i++)
    {
      ...
      if (done_kinfit == 1 && data_flag)
      {
        if (good_clus == 0)
        {
          ...
          cond_ene = cluster[4][ncll[ind_gam[0]] - 1] > KLOE::MIN_CLU_ENE &&
          ...
          cond_clus[0] = cluster[3][ncll[ind_gam[0]] - 1] > 0 && cluster[0][ncll[ind_gam[0]] - 1] != 0 && cluster[1][ncll[ind_gam[0]] - 1] != 0 && cluster[2][ncll[ind_gam[0]] - 1] != 0;
          cond_clus[1] = cluster[3][ncll[ind_gam[1]] - 1] > 0 && cluster[0][ncll[ind_gam[1]] - 1] != 0 && cluster[1][ncll[ind_gam[1]] - 1] != 0 && cluster[2][ncll[ind_gam[1]] - 1] != 0;
          cond_clus[2] = cluster[3][ncll[ind_gam[2]] - 1] > 0 && cluster[0][ncll[ind_gam[2]] - 1] != 0 && cluster[1][ncll[ind_gam[2]] - 1] != 0 && cluster[2][ncll[ind_gam[2]] - 1] != 0;
          cond_clus[3] = cluster[3][ncll[ind_gam[3]] - 1] > 0 && cluster[0][ncll[ind_gam[3]] - 1] != 0 && cluster[1][ncll[ind_gam[3]] - 1] != 0 && cluster[2][ncll[ind_gam[3]] - 1] != 0;

          if (cond_ene == true && cond_clus[0] && cond_clus[1] && cond_clus[2] && cond_clus[3])
          {
            for (Int_t k = 0; k < 4; k++)
            {
              Clu5Vec[k][0] = cluster[0][ncll[ind_gam[k]] - 1];
              Clu5Vec[k][1] = cluster[1][ncll[ind_gam[k]] - 1];
              Clu5Vec[k][2] = cluster[2][ncll[ind_gam[k]] - 1];
              Clu5Vec[k][3] = cluster[3][ncll[ind_gam[k]] - 1];
              Clu5Vec[k][4] = cluster[4][ncll[ind_gam[k]] - 1];
            }
