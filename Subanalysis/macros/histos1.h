...
// Fri Jun 16 01:16:49 2023 by ROOT version 6.24/07
...
class histos1 : public TSelector {
public :
   ...
   TTreeReaderArray<UChar_t> ivOld = {fReader, "ivOld"};
