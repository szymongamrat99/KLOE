...
// Tue Oct 10 09:08:33 2023 by ROOT version 6.24/07
// from TChain INTERF/h1/
//////////////////////////////////////////////////////////

#ifndef neutral_vtx_resolutions_h
#define neutral_vtx_resolutions_h
...
class neutral_vtx_resolutions : public TSelector {
public :
   ...
   TTreeReaderArray<UChar_t> pidmcOld = {fReader, "pidmcOld"};
   ...
   TTreeReaderArray<UChar_t> vtxmcOld = {fReader, "vtxmcOld"};
   TTreeReaderValue<Int_t> nvtxmc = {fReader, "nvtxmc"};
   TTreeReaderArray<UChar_t> kinmom = {fReader, "kinmom"};
   TTreeReaderArray<UChar_t> motherOld = {fReader, "motherOld"};
   ...
   neutral_vtx_resolutions(TTree * /*tree*/ =0) { }
   virtual ~neutral_vtx_resolutions() { }
   ...
   ClassDef(neutral_vtx_resolutions,0);

};

#endif

#ifdef neutral_vtx_resolutions_cxx
void neutral_vtx_resolutions::Init(TTree *tree)
{
...
Bool_t neutral_vtx_resolutions::Notify()
{
...
#endif // #ifdef neutral_vtx_resolutions_cxx
