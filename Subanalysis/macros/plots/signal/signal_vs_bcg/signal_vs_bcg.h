...
#ifndef signal_vs_bcg_h
#define signal_vs_bcg_h
...
class signal_vs_bcg : public TSelector
{
public:
  ...
  signal_vs_bcg(TTree * /*tree*/ = 0) {}
  virtual ~signal_vs_bcg() {}
  ...
  ClassDef(signal_vs_bcg, 0);
};

#endif

#ifdef signal_vs_bcg_cxx
void signal_vs_bcg::Init(TTree *tree)
{
